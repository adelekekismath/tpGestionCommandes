...
namespace Api.Databases.Migrations
{
    ...
    [Migration("20251111145035_add_column_description_to_column")]
    partial class add_column_description_to_column
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Entities.Categorie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Entities.LigneCommande", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Entities.Produit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Entities.LigneCommande", b =>
                {
                    b.HasOne("Api.Domain.Entities.Commande", "Commande")
                        .WithMany("LignesCommande")
                        .HasForeignKey("CommandeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Domain.Entities.Produit", "Produit")
                        .WithMany("LignesCommande")
            ...
            modelBuilder.Entity("Api.Domain.Entities.Produit", b =>
                {
                    b.HasOne("Api.Domain.Entities.Categorie", "Categorie")
                        .WithMany("Produits")
